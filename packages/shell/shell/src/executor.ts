/**
 * The `ctx.shell` service class and its settings namespace: the abstract
 * execution service every executor implements, and the capability-owned
 * settings namespace the local executor families share.
 * @module @deepseek-ai/dsh-shell/executor
 */
