...
// The public contract vocabulary (tool/execution shapes, pipeline decisions,
// canonical codes and errors, and the shared snapshot helpers) lives in
// `definitions.ts` — the registry and pipeline in this file are its only
// consumer. Re-exported here so `@deepseek-ai/dsh-tools` stays the single
